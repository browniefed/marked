...
var markAMD = (function() {
      ...
      var cap,
          ...
          while (src) {
            if (cap = this.rules.tag.exec(src)) {
              src = src.substring(cap[0].length);
              out = mergeStyles(out, this.renderer.style(cap[1].match(this.styles.style)));
              continue;
            }
          }
    ...
    StyleRenderer.prototype.style = function() {
      return styleRender[cap[1]](cap[2]);
    }
    ...
    InlineLexer.prototype.output = function(src) {
      ...
      while (src) {
        ...
        if (cap = this.rules.styled.exec(src)) {
          src = src.substring(cap[0].length);
          out += this.renderer.styled(this.output(cap[2]), cap[1]);
          continue;
        }
